...
from sim_pencil_game_alpha_go_zero.simulation.add_board import add_board
...
class TopDownGraspingEnv:
    ...
    def set_board_texture(self) -> None:
        """
        Load texture onto board
        """
        tex_id = pb.loadTexture("assets/textures/simgraph.png")
        pb.changeVisualShape(self.board_id, -1, -1,
